	...
	<div id="header" class="container">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="index.jsp" accesskey="4" title="">Logout</a></li>
...
try
{
			...
			PreparedStatement pst=conn.prepareStatement("select * from e_leave");
...
%>
<center>
<form action="changeleavecheck.jsp" method="post" name="form7">

		<table border="0" style="border-collapse:collapse;width:50%;height:150px;text-align:center;margin:50px;">
        <tr>
		<td>EMP Leave ID</td>
		<td><Input type="text"  name="elid"></td>
		</tr>
		<tr>
		<td>Approval status</td>
		<td><Input type="text"  name="aps"></td>
		</tr>	
         <td><input type="hidden" name="buttonname" /></td>
         
		<tr>
       
		<td><input type="submit"  name="action" value="Update" onClick="return validation()"></td>
